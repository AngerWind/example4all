...
import (
	...
	"github.com/tiger/example4k8s-operation/internal/controller"
	webhookwebappv1 "github.com/tiger/example4k8s-operation/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8b106420.tiger.com",
