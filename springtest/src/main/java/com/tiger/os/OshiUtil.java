...
public class OshiUtil {
    ...
    private static void printComputerSystem(final ComputerSystem computerSystem) {
        ...
        System.out.println("manufacturer: " + computerSystem.getManufacturer()); // 机器制造商
        System.out.println("model: " + computerSystem.getModel());  // 机器型号
        System.out.println("serialnumber: " + computerSystem.getSerialNumber()); // 机器序列码，SN码
        final Firmware firmware = computerSystem.getFirmware();
        System.out.println("firmware:");
        System.out.println("  manufacturer: " + firmware.getManufacturer()); // 固件制造商
        System.out.println("  name: " + firmware.getName()); // 固件名称
        ...
        final Baseboard baseboard = computerSystem.getBaseboard(); // 主板信息
    ...
    private static void printProcessor(CentralProcessor processor) {
        ...
        System.out.println(" " + processor.getPhysicalPackageCount() + " physical CPU package(s)"); // 物理cpu个数
        System.out.println(" " + processor.getPhysicalProcessorCount() + " physical CPU core(s)"); // 总物理核心数， 等于cpu个数*每个cpu核心
        System.out.println(" " + processor.getLogicalProcessorCount() + " logical CPU(s)"); // 逻辑cpu个数，如果逻辑cpu个数不等于物理核心数，说明使用了超线程
    ...
    private static void printSensors(Sensors sensors) {
        ...
        System.out.format(" CPU Voltage: %.1fV%n", sensors.getCpuVoltage()); // cpu电压
    }
