<template>
  <div class="app">
    ...
    <div class="navigate">
      ...
      <!-- 注意, 这里已经从vue2的 router-link 标签变成了 RouterLink 标签了 -->
      <!-- 通过to来指定路由的路径, 然后会通过路径去匹配对应的组件 -->
    ...
    <div class="main-content">
      ...
      <!-- 注意, 这里已经从 vue2 的 router-view 标签变为了 RouterView 标签了 -->
...
// 注意, 这里需要导入RouterView和RouterLink组件
// 在vue2中是不需要导入的, 可以直接使用
