...
import static com.tiger.im.MessageType.HANDSHAKE;
...
public class LoginAuthRespHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (HANDSHAKE.getMsgType() == handshakeRespMsg.getHead().getMsgType()) {
            ...
            try {
                ...
                if (status == 1) {
                    ...
                    // todo 服务器认证失败, 说明从一开始token就是错误的, 那么就应该报错出去, 应该抛出exception, 而不是重连
